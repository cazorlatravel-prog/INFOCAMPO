...
<head>
    ...
    <style>
        ...
        .link-box {
            ...
            padding: 8px 12px; font-size: 0.8rem; word-break: break-all;
            display: flex; align-items: center; gap: 8px;
        }
        .link-box code {
            flex: 1; color: #1e3a5f; font-size: 0.78rem;
        }
        .btn-copy {
            border: none; background: #1e3a5f; color: #fff; padding: 4px 10px;
...
<body>
    ...
    <nav class="nav-admin">
        <ul class="nav">
            ...
            <li><a href="usuarios.php<?= $empresaId ? '?empresa_id=' . $empresaId : '' ?>" class="nav-link active">
